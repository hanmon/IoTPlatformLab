#讀取設備感測器時間區間內多筆感測資料統計資訊，包括SUM、COUNT、MIN、MAX與AVG
import requests
import json
import configparser
...
apiURL = 'http://iot.cht.com.tw/iot/v1/device/' + deviceId + '/sensor/' + sensorId + '/rawdata/statistic'
#串接HTTP GET查詢字串，包括開始與結束時間，格式為 ISO 8601,例如:2016-07-14T23:55:00Z
#每次查詢上限為 100,000 筆
